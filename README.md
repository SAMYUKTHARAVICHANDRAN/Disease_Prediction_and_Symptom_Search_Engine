...
Core Data Structures: Trie, Graph, HashMap, ArrayList

Algorithms: PageRank, TimSort, Prefix Search, Weighted Edge Construction
...
Real-time symptom suggestions using Trie

Ranked disease predictions with confidence scores
